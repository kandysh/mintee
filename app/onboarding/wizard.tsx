...
// Step 1 Content from app/onboarding/page.tsx
...
// Step 2 Content from app/onboarding/role/page.tsx
...
export default function OnboardingWizard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-primary/5 py-20 px-4">
      {step === 1 && <OnboardingIntroduction onContinue={handleNext} />}
      {step === 2 && <RoleSelection onContinue={handleNext} onBack={handlePrev} />}
    </div>
  );
}
